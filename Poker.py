    ...
    for j in range(0, len(self.players)):
      if (self.is_royal(self.players[j])):
        ...
        while(i < 4 and self.players[j][i]==self.players[j][i+1]):
            i+=2
        if (i==0):
            temp_hand.append(self.players[j][1:5])
        elif (i==2):
            temp_hand.append(self.players[j][0:2])
            temp_hand.append(self.players[j][3:5])
        elif (i==4):
            temp_hand.append(self.players[j][0:4])
        ...
        if (i==0):
            ...
            temp_hand.append(self.players[j][2:5])
        elif (i==1):
            ...
            temp_hand.append(self.players[j][0:3])
        self.players[j] = temp_hand
